...
\cellcolor{lightgray} \textbf{Objective} & {\color{textgray} Provide mainly software testers together with students with an intuitive as well as interactive way to explore the interplay of transformations and their effects on fixed points in space to gain a better understanding of their individual problem at hand.} \\ \hline  

\cellcolor{lightgray} \textbf{Main tagret group} & {\color{textgray} Software testers} \\ \hline 
\cellcolor{lightgray} \textbf{Secondary tagret group} & {\color{textgray} Students} \\ \hline 
\cellcolor{lightgray} \textbf{Target release} & \tcbox[colframe=TAGgreen, colback=TAGgreen]{\textbf{\footnotesize 2 Feb 2025}} \\ \hline 

\cellcolor{lightgray} \textbf{Key Perf. Measures} & {\color{textgray} Customer feedback, Employee satisfaction, Session duration} \\ \hline 

\cellcolor{lightgray} \textbf{Status} & \tcbox[colframe=TAGgreen, colback=TAGgreen]{\textbf{\footnotesize Done}} \\ \hline 

\cellcolor{lightgray} \textbf{Designer} & {\color{textgray} Ivo Prahm} \\ \hline 
\cellcolor{lightgray} \textbf{Web Application} & {\color{textblue} \href{https://ivolino.de/plane}{ivolino.de/plane}} \\ \hline  
\cellcolor{lightgray} \textbf{Git Repo.} & {\color{textblue} \href{https://github.com/Den-Prahms-ihr-Ivo/DLMCSPSE}{GitHub - Den-Prahms-ihr-Ivo/DLMCSPSE } } \\ \hline 
