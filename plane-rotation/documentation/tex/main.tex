...
\definecolor{textblue}{rgb}{0.258,0.521,0.9568}
...
\input{chapters/1_Conception_Phase} 
\pagebreak
\section{Implementation Phase}
\input{chapters/2_Implementation_Phase} 
\pagebreak
\section{Test Document}
\input{chapters/3_Test_Document} 
\pagebreak
\section{Finalisation Phase}
\input{chapters/3_Finilization_Phase} 
\pagebreak
\section{Glossary}
